...
function Approval() {
  ...
  const fetchOneWO = async () => {
    const res = await getData(`/checkout/${id}`);
    const { UserRequest, Departement, NamaBarang, KodeBarang, Permasalahan, UserApprove, Date_RequestWO, StatusWO } = res.data.data;
    setForm({
  ...
  return (
    <>
      <Navbar />
      <section className="approval workOrder mx-auto">
        <div className="row">
          <div className="col-md-6 my-auto py-md-0 pt-md-5 pb-md-5 pt-3 pb-3">
          ...
          <div className="col-md-6 bg-blue pt-md-5 pb-md-5 d-md-block d-none">
            <Card style={{ width: "80%" }} className="m-auto mt-5 mb-5">
              <Card.Body>
                <Card.Title className="text-center mb-5">Work Order</Card.Title>
                <DetailApproval form={form} />
