...
function Blog() {
  return (
    <div>
      <header>
        <div class="jumbotron">
          <h1 className="text-4xl fw-bold">Work Order</h1>
      ...
      <main>
        <div id="content">
          <article id="definisi" class="card">
            <h2 className="text-3xl fw-bold">Definisi</h2>
            <p className="text-lg m-0">
          ...
          <article id="visidanmisi" class="card">
            ...
            <p className="text-lg m-0">
              ...
              dan juga perencanaan dari suatu pekerjaan. Work order akan berisi
              informasi terkait batasan pekerjaan yang memang harus dilakukan
              dan terkait objek teknis berbentuk operasi, lokasi, jadwal mulai
              dan selesai, serta durasi kerja.
            </p>
          </article>
          ...
          <article id="organisasimahasiswa" class="card">
            ...
            <p className="text-lg m-0">
              ...
              mereka yang berada di bagian perencanaan produksi. Perintah kerja
              tersebut dibuat untuk lebih dari satu produksi atau bisa juga
              merupakan proses dari permintaan sales order atau pesanan
              penjualan.
            </p>
            <ol>
              <li>
                ...
                <p className="text-lg m-0">
                  Pada bagian atas atau header berisi informasi umum pekerjaan,
                  yaitu User, Departemen, Nama Peralatan, Kode Peralatan,
                  Tanggal Work Order, Tanggal Pengerjaan.
                  <ol>
                    ...
                    <li>
                      Nama Peralatan: Nama Peralatan yang ingin diperbaiki atau
                      diganti
                    </li>
                    <li>
                      Kode Peralatan: Kode Peralatan yang ingin diperbaiki atau
                      diganti
                    </li>
                    <li>
              ...
              <li>
                ...
                <p className="text-lg m-0">
                  ...
                  yakni Permasalahan, Tindakan, Sparepart Yang Diganti, Pemohon,
                  Disetujui, Dikerjakan, Diketahui. Berikut ini adalah
                  penjelasannya:
                  <ol>
                    <li>
                    ...
                    <li>
                      Tindakan: Hasil akhir dari divisi IT dalam menangani work
                      order yang diberikan user
                    </li>
                    <li>
        ...
        <aside>
          <article class="card">
            <header className="text-center">
              <h4 className="font-semibold">PT. Arai Rubber Seal Indonesia</h4>
